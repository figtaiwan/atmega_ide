...
;  建 INTERUPT VECTOR CALL表 ( 共 26 interrupt, 佔2*26 words =52 words = 104 bytes ) ( 52 =ox34 words )
	...
	RCALL		ISR_HEAD	;2, INT0
		RCALL		ISR0
	RCALL		ISR_HEAD	;3, INT1
		RCALL		ISR0
	RCALL		ISR_HEAD	;4
		RCALL		ISR0
	RCALL		ISR_HEAD	;5
...
BUFQ:
	...
	CODE	4,"BUF@"	; a new/old -- buuf_addr
BUFAT:
	RCALL	AT
	RCALL	BUFFER
	RCALL	SWAPP
...
;	Change character to upper case
	...
	CODE	5,"UPPER"
UPPER:
   RET      ; NO capitalize ; albert  2012/5/2 
	RCALL	DUPP
	RCALL	DOLIT
	.DW		$61
	RCALL	DOLIT
...
ACCP1:
	...
	RCALL	SUBB
	RCALL	DOLIT
	.DW		$FF    ; $FF for chinese ; $5F  FOR ASCII CODE ; albert  2012/5/2 
	RCALL	ULESS
	RCALL	QBRAN
	.DW		ACCP2
	RCALL	TAP
...
ABORT:
	...
	ldi 	yh,high(SPP)
	RJMP	QUIT
COLON	12,"ERR_HANDLING" ; ADD FOR CHANGE 8 / 23  
ERR_HANDLING:
    JMP  RAT
COLON	10,"ALLOW_BOOT" ;  ADD FOR CHANGE 8 / 30 
ALLOW_BOOT:
    JMP  RAT
	RET
...
QUIT2:
	RCALL	DOLIT	; 		20130926 sam
	.DW		6		; ACK 	20130926 sam
	RCALL	EMIT	; 		20130926 sam
...
COLD1:
	...
	.DW		$100
	RCALL	DUPP
	CALL	READ	;initialize user area
	CALL	DOLIT	;init older buffer
	.DW		OLDER
	RCALL	AT		;
	RCALL	READ_FLASH
	RCALL	SWITCH
	CALL	DOLIT	;init newer buffer
	.DW		OLDER
	RCALL	AT		;
	RCALL	READ_FLASH
	RCALL	SWITCH
...
; 	transfer data from RAM to Flash page buffer
	...
	COLON	5,"WRITE";; Device dependent I/O
	JMP	WRITE
...
;	Compile tos to code dictionary as an integer literal.
	...
	COLON  IMEDD+7,"LITERAL" ; FIXED 2012/9/25
LITER: 
	CALL	DOLIT
	.DW		DOLIT
	CALL	CALLC
